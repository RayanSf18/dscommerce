...
public class ProductController {
    ...
    @GetMapping
    public ResponseEntity<Page<ProductDTO>> searchProducts(@RequestParam(name = "name", defaultValue = "") String name, Pageable pageable) {
        return ResponseEntity.ok().body(this.productService.searchProducts(name, pageable));
    }
